...
import com.etcmc.etccore.command.CustomCommand;
...
public class CommandManager {
    ...
    public CommandManager(ETCCore plugin) {
        this.plugin = plugin;
    }
    ...
    public void dispatchAction(org.bukkit.entity.Player player, String action, String[] args) {
        ...
        com.etcmc.etccore.command.CustomCommand.fireAction(plugin, player, action, args);
    }
}
